...
// The stable project alias, not a per deployment URL, so redeploying the
// proxy does not quietly break the public page.
const PROXY = 'https://evolv-proxy.vercel.app'
